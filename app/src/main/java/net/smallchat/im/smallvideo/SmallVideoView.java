 ...
 */
public class SmallVideoView extends SurfaceView implements mMediaController.MediaPlayerControl, View.OnTouchListener {
...
//                    canSeekForward();
    ...
    public SmallVideoView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initVideoView() {
        ...
        final View v = inflater.inflate(R.layout.small_video_media_controller, null);
