...
package net.smallchat.im.components.tab;
...
public class TabHost extends FrameLayout implements ViewTreeObserver.OnTouchModeChangeListener {
    ...
    /**
      ...
      * Example:</p>
<pre>mTabHost = (TabHost)findViewById(R.tid.tabhost);
mTabHost.setup();
mTabHost.addTab(TAB_TAG_1, "Hello, world!", "Tab 1");
    ...
    public void setup() {
        ...
        if (mTabWidget == null) {
            throw new RuntimeException(
                    "Your TabHost must have a TabWidget whose tid attribute is 'android.R.tid.tabs'");
        }
        ...
        if (mTabContent == null) {
            throw new RuntimeException(
                    "Your TabHost must have a FrameLayout whose tid attribute is "
                            + "'android.R.tid.tabcontent'");
        }
    }
    ...
    public class TabSpec {
        ...
        /**
         * Specify the tid of the view that should be used as the content
         * of the tab.
         */
    ...
    /**
     * How to create the tab content via a view tid.
     */
        ...
        private ViewIdContentStrategy(int viewId) {
            ...
            if (mView != null) {
                ...
                throw new RuntimeException("Could not create tab content because " +
                        "could not find view with tid " + viewId);
            }
        }
