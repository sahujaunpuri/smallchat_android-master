...
public class RedPacketActivity extends BaseActivity
    ...
    // The mapinfo to send
    private MessageRedPacket mMessageRedPacket;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_redpacket_layout);
        mContext = this;
        ...
        if (!mFullScreen) {
            ...
            mSearchResultView.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (position == 0) {
                        loc = (LatLng) item;
                        mMessageRedPacket = new MessageRedPacket();
                    } else {
                        ...
                        switch (whichButton) {
                            case 0://收藏
                                MovingLoaction movingLocation = new MovingLoaction(curLocation.latitude + "",
                                        curLocation.longitude + "", curLocAdd, MessageType.REDPACKET + "");
    ...
    public class SearchResultAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            // The first is the current position
            if(position == 0){
                holder.mLocTextView.setText("[" + mContext.getString(R.string.message_type_redpacket) + "]");
